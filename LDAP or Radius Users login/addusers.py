...
def Create_users():
    ...
    for i in range(1,6001):
        sheet1.write(i,0,"test{}".format(i))
        sheet1.write(i,1,"test{}".format(i))
        sheet1.write(i,2,"hyllydia@2020")
        sheet1.write(i, 3, "Siemax.com")
    #保存文件
    xls.save("D:\create_users.xls")
def xls_to_csv():
    workbook = xlrd.open_workbook('D:\create_users.xls')
    table = workbook.sheet_by_name("Sheet1")
    with codecs.open('D:\create_users.csv', 'w',encoding="utf-8") as f:
        write = csv.writer(f)
