...
req_url = 'https://10.7.100.204:3443'
...
shared_secret = b"abcd1234" # Set the secret in between the quotation marks.
...
def update_json(user_action, user_ip, user_name, user_domain):
...
def push_login():
	global req
	#update_json(user_action, user_ip, user_name)
...
def push_logout(user_ip):
	global req
	#update_json(user_action, user_ip, user_name, user_domain)
...
def LoginLoop(num):
	...
	for i in range(1, num):
		a, b ,c= deal_abc(a, b, c)
		user_name = "ssouser" + str(i)
		user_domain = "Siemax.com"
		user_ip = "102." + str(a) +"."+ str(b)+"."+str(c)
		print("user_ip %s user_name %s" %(user_ip, user_name))
		update_json(user_action, user_ip, user_name, user_domain)
		push_login()
		c=c+1
...
#LoginLoop(num)
	print(datetime.datetime.now())
	#print("after sleeping 600 secs, delete them all")
	#time.sleep( 600 )
#LogoutLoop(num)
	#time.sleep( 600 )
