...
if __name__=="__main__":
    ...
    # #test.post_s2s_vpn_IKEv2('10.7.100.202',1,10000,100)
    # test.post_vpn_chained_3rd(ipstr=ipstr, sn=3401,en=3800,step=100)
